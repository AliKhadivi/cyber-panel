...
Postfix_Switch=${Postfix_Switch:-On}
PowerDNS_Switch=${PowerDNS_Switch:-On}
PureFTPd_Switch=${PureFTPd_Switch:-On}
...
#   echo -e "\nAdmin password will be set to $Admin_Pass\n"
# fi
Admin_Pass=${Admin_Pass:-123456789}
echo -e "\nAdmin password will be set to $Admin_Pass\n"
